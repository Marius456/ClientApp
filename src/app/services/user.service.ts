...
import { Bookmark, Tracker, State, Role } from './../entities/user';
...
export class UserService {
  ...
  updateRole(UserId: GUID, pass: Role): Observable<User> {
    return this.http.put<User>(this.Url + "changerole/" + UserId, pass)
  } 
